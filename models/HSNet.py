...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes_branch=2, num_classes=14):
        ...
        self.layer4 = self._make_layer(block, 512, layers[5], stride=2)
...
def HSNet_model(pretrained=True, **kwargs):
    """Constructs a ResNet-50 model.

    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(Bottleneck, [3, 4, 2, 1, 6, 3], **kwargs)
    if pretrained:
